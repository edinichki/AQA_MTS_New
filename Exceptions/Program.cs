...
// checkedExceptions.ReadFile("file.txt");              //у нас нет такого файла

// -====================== Unchecked Exceptions ======================-
UncheckedExceptions uncheckedExceptions = new UncheckedExceptions();
// uncheckedExceptions.DivideNumbers(1, 0);             //попытка деления на ноль 
...
if (int.TryParse(data, out var x1))                  //попытка конвертировать x в int
{
