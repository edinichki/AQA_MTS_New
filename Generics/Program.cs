...
// -=================== Generics ===================-
GenericPerson<int> intPerson = new GenericPerson<int>(123, "Alex"); //указали, что экземпляр этого класса тут будет int 
intPerson.Print();

// -=================== Варианты
GenericPerson<string> strPerson = new GenericPerson<string>("- 123 -", "Alex");
GenericPerson<Guid> uniquePerson = new GenericPerson<Guid>(Guid.NewGuid(), "Alex"); //Guid уникальный айдишник, состоящий из 5ти блоков
uniquePerson.Print();
...
string x1 = "10";
string y1 = "15";
Helper.Swap(ref x1, ref y1); //не обязательно конкретизировать метод Swap, что он тут стринговый, прога сама поймет
