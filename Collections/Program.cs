...
// -==================== yield               //создание итераторов, что позволяет нам перебирать какую-то последовательность элементов
IEnumerable<int> GenerateNumbers(int count)  //возвращает элемент последовательно по мере их генерации
{
