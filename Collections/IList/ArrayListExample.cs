...
public class ArrayListExample
{
    public void Run()
    {
        ...
        // Создаем ArrayList для хранения строк в С# 12               //определение начальных значений нашей коллекции самых разных типов
        ...
        foreach (var item in stringList) // Рекомендуемый вариант var
        {
        ...
        PrintHelper.PrintCollection(stringList);      //вызываем метод, указывая в каком классе он лежит
    }
}