...
public class ListExample
{
    public void Run()
    {
        ...
        List<string> stringList1 = new List<string>(16);         //сразу указываем Capacity для ускорения обработки, если сразу знаем кол-во элементов
        ...
        // Поиск индекса элемента                    -- если коллекция не отсортирована
