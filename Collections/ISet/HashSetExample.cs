...
public class HashSetExample
{
    public void Run()
    {
        ...
        // Вывод элементов после Except -- оставили элементы, которые отличаются
        Console.WriteLine("\nNames after except:");
        ...
        */
        ...
        // Вывод элементов после пересечения -- одинаковые элементы  из двух коллекций
        ...
        Console.WriteLine($"IsProperSupersetOf : {uniqueNames.IsProperSupersetOf(exceptNames)}"); //сожержит ли он в себе какое-то множество
        Console.WriteLine($"IsProperSubsetOf : {exceptNames.IsProperSubsetOf(uniqueNames)}");   //является ли он подмножеством
    }
}
