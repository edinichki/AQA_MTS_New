...
public class WebDriverTest
{
    ...
    public void SimpleDriverTest()
    {
        ...
        webDriver.Manage().Window.Maximize();                 //установили максимальный размер окна
        webDriver.Navigate().GoToUrl("http://onliner.by");    //переход на страницу
        webDriver.Quit();                                     //команда для автоматического закрытия браузера
    }
