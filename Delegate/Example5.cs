...
public class Example5
{
    ...
    public void Run()
    {
        NoParameters noPrm = delegate { Console.WriteLine("Have fun!!!"); };  //объявили делегат, назначили ему ссылку на анонимный метод

        // Делегаты как параметры методов
        Console.WriteLine(Test(noPrm));                //потом вызвали метод, который принимает в кач-ве параметра делегат
