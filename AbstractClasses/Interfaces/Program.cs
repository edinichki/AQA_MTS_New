...
// -======================== Interfaces ========================-
// IDisplayable displayable = new IDisplayable(); - Ошибка - нельзя создать объект на основании интерфейса
...
// tablet.DrawBorders();
// smartphone.DrawBorders(); Ошибка - метод DrawBorders() не определен в классе, он определен в интерфейсе и не может перекочевать
